	...
	if(!isset($_POST['host'])){
		...
		<form class="form-horizontal" action="installer.php" method="post">
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" name="user" placeholder="MySQL username">
				</div>
			</div>
			<div class="control-group">
			...
			<div class="control-group">
				<label class="control-label">Stable links (use UUIDs instead of player names for navigation):</label>
				<div class="controls">
					<select name="stablelinks">
						<option>true</option>
						<option>false</option>
					</select>
				</div>
